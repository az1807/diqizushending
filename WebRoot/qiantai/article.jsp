<%@ page language="java" import="java.util.*,com.FanDian.entity.*" pageEncoding="utf-8"%>
<%
...
<div>
    <header class="header-article-list">
        ...
        <ul>
         <%
              List<XinWenLeiB> xwlb =  (List<XinWenLeiB>)request.getAttribute("xwlb");
                 %>
                 
                 <% for (int i=0;i<xwlb.size();i++){ %>
                 
                  <li><a href="#"><%=xwlb.get(i).getLeib() %>></a></li>
            <%    } %>
